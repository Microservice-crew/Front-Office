...
const AddSponsorComponent = () => {
    ...
    const submitData = (event) => {
        ...
        // Include your logic for submitting the sponsor data
    };
        ...
        <div id="content-page" className="content-page">
            <Container>
                <div style={{ marginBottom: '20px' }}>
                    <h1 style={{ borderBottom: '1px solid #e0e0e0', paddingBottom: '10px' }}>Add Your Sponsor</h1>
                </div>
